    ...
    def __init__(
        ...
        self.add_item(
            PaginatorButton(
                ...
                custom_id="pages",
                emoji=Emojis.NAVIGATE_PAGINATOR,
            )
        )
        self.add_item(
            PaginatorButton(
...
class PagesModal(discord.ui.Modal, title="Select Page"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            return await interaction.warn("Provide a valid page number.")
